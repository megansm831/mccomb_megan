# Readability and Lexical Diversity Workshop -------------------------------
...
# Determine which school's tweets are easiest to read based on Coleman-Liau Grade Level. 

full_data %>% 
  group_by(school) %>% 
  summarise(ave_readability = mean(coleman.liau))
